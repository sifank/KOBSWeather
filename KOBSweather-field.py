...
for (time,
  ...
  print("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n" % (fallskyTemp, fallskyHum, fallskyDp, fallskyPres, fallskyWind, fallskyWGust, obsRain, Raining, fallskySkyTemp, fallskyLux))
